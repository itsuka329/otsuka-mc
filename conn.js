...
const { listmenu, randomimage,ephoto,textprop,nsfwmenu,cerpenn,animemenu,wallpaper,stickerrandom,information,audiochanger,asupangacha,primbonna,randomm,vokalmenu,sosmed,anonymousss,logoo,sertifikat,randomcek,bugvip,toolsmenu,conberts,downloadmenu,autodects,groupmenu,storemenu,ownermenu,usermenu, donasiBot, infoOwner } = require('./help')
...
const isOwner = [`${setting.ownerNumber}`,"6285156476017@s.whatsapp.net","6282215393363@s.whatsapp.net"].includes(sender) ? true : false
...
const dfrply = fs.readFileSync('./Otsuka.jpg')
try {
...
"fileName": `OtsukaBot-MD ${ngazap(prefix)}`,
...
*_Seputar OtsukaBot & transaksi_*

${strip}Telpon/Spam blokir 🚫${strip}

_Admin  : 6285156476017_
...
const gurbot = '6285156476017@s.whatsapp.net'
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${usermenu(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})
}
break
//-----------------------------------------------------------------------
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${primbonna(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})
}
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${randomm(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${randomimage(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${ephoto(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${textprop(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${animemenu(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${wallpaper(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${information(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${logoo(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${sertifikat(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${randomcek(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${stickerrandom(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${cerpenn(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${asupangacha(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${conberts(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${toolsmenu(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${autodects(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${sosmed(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${anonymousss(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${bugvip(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${downloadmenu(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${groupmenu(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${storemenu(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${ownermenu(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${vokalmenu(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 @${mark_slebew.split("@")[0]}`
var menu_nya =`${audiochanger(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥' }, type: 1 },{buttonId: `${prefix}rules`, buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
var but_menu = {text: menu_nya,footer: footer_nya,buttons: btn_menu,mentions: [sender, mark_slebew],headerType: 1}
conn.sendMessage(from, but_menu, {quoted:msg})}
break
...
//-----------------------------------------------------------------------
   const sections = [
	...
	rows: [
    {
     ...
     {
	    title: "𝙋𝙍𝙄𝙈𝘽𝙊𝙉 𝙈𝙀𝙉𝙐", 
	    rowId: `${prefix}primbonna`
	   },
     {
	    title: "𝙍𝘼𝙉𝘿𝙊𝙈 𝙈𝙀𝙉𝙐", 
	    rowId: `${prefix}randomm`
	   },
     {
	    title: "𝙍𝘼𝙉𝘿𝙊𝙈 𝙄𝙈𝘼𝙂𝙀", 
     ...
     {
	    title: "𝙎𝙀𝙍𝙏𝙄𝙁𝙄𝙆𝘼𝙏 𝙈𝙀𝙉𝙐", 
	    rowId: `${prefix}sertifikat`
	   },
     {
	    title: "𝙉𝙎𝙁𝙒 𝙈𝙀𝙉𝙐 ", 
     ...
     {
	    title: " 𝙒𝘼𝙇𝙇𝙋𝘼𝙋𝙀𝙍 𝙈𝙀𝙉𝙐", 
	    rowId: `${prefix}wallpaper`
	   },
     {
	    title: "𝙄𝙉𝙁𝙊𝙍𝙈𝘼𝙏𝙄𝙊𝙉 𝙈𝙀𝙉𝙐", 
	    rowId: `${prefix}information`
	   },
     {
	    title: "𝙍𝘼𝙉𝘿𝙊𝙈 𝘾𝙀𝙆", 
	    rowId: `${prefix}randomcek`
	   },
     {
	    title: "𝙍𝘼𝙉𝘿𝙊𝙈 𝙎𝙏𝙄𝘾𝙆𝙀𝙍", 
	    rowId: `${prefix}stickerrandom`
	   },
     {
	    title: "𝙑𝙊𝙆𝘼𝙇 𝙈𝙀𝙉𝙐 ", 
     ...
     {
	    title: "𝘼𝙐𝙏𝙊𝘿𝙀𝘾𝙏 𝙈𝙀𝙉𝙐", 
	    rowId: `${prefix}autodects`
	   }, 
     {
	    title: "𝘼𝙐𝘿𝙄𝙊 𝘾𝙃𝘼𝙉𝙂𝙀𝙍", 
	    rowId: `${prefix}audiochanger`
	   }, 
     {
	    title: "𝙎𝙊𝙎𝙈𝙀𝘿 𝙎𝙃𝙊𝙋", 
	    rowId: `${prefix}sosmed`
     ...
     {
	    title: "𝘼𝙉𝙊𝙉𝙔𝙈𝙊𝙐𝙎 𝙈𝙀𝙉𝙐 ", 
	    rowId: `${prefix}anonymousss`
	   },
     {
	    title: "𝘿𝙊𝙒𝙉𝙇𝙊𝘼𝘿 𝙈𝙀𝙉𝙐", 
...
let premnya = `${cekUser("premium", sender)? 'Aktif':'Tidak'}`
let usernya = `${("id", db_user).length}`
let menunyaa = `Menampilkan List Menu Otsuka Bot
...
├ *jam* : ${jam}
├ *Date* : ${tanggal} WIB
├ *Terdaftar* : ${usernya} WITA
├ *Room Chat* : ${romnya} WIT
└─❖
...
const listMessage = {
text: menunyaa,
footer: "© Created By OtsukaBot",
title: "━━━[ LIST OTSUKABOT MENU ]━━━",
buttonText: "Klik Disini",sections}
const sendm =  conn.sendMessage(from, listMessage)}
break
//-----------------------------------------------------------------------
case 'donate':
case 'donasi':{
...
var bg_lexxy = '6285156476017@s.whatsapp.net'
...
conn.sendMessage(from, { caption: cap, image: { url: feta.data.qris }, buttons: buto, footer: '© created by OtsukaBot' })
}
console.log(feta)
}
break
...
var dev = '6285156476017@s.whatsapp.net'
